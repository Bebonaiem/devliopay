...
<p style="margin:0 0 24px;font-size:15px;color:#94a3b8;">We've received your payment. Thank you!</p>
...
<span style="color:#22c55e;font-size:18px;font-weight:700;">Payment Confirmed</span>
</td></tr>
</table>
...
<tr>
<td style="padding-bottom:12px;"><span style="color:#94a3b8;font-size:13px;">Amount Paid</span></td>
...
<td style="text-align:right;"><span style="color:#e2e8f0;font-size:15px;font-weight:600;">{date}</span></td>
</tr>
</table>
</td></tr>
</table>

<p style="margin:0;font-size:14px;color:#94a3b8;">A receipt has been attached to this email for your records.</p>
