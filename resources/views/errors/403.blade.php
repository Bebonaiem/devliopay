...
<body>
    <div class="container">
        ...
        <div class="message">You don't have permission to access this page. If you think this is a mistake, please contact support.</div>
        <a href="/" class="btn">Go Home</a>
        <div class="links">
            <a href="/login">Login</a>
            <a href="/client">Dashboard</a>
            <a href="/tickets/create">Open Ticket</a>
        </div>
    </div>
</body>
</html>
