        ...
        <div class="flex flex-wrap items-end gap-3">
            <div class="flex-1 min-w-[200px]">
                ...
                <select wire:model.live="selectedLog"
                        class="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white shadow-sm focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none">
            ...
            <div>
                ...
                <div class="flex gap-1.5">
                    @php
                        $levels = [
                            'all' => ['label' => 'All', 'active' => 'bg-primary-600 text-white', 'inactive' => 'bg-white/5 text-white/70 hover:bg-white/10 border border-white/10'],
                            'debug' => ['label' => 'Debug', 'active' => 'bg-gray-500 text-white', 'inactive' => 'bg-white/5 text-white/70 hover:bg-white/10 border border-white/10'],
                            'info' => ['label' => 'Info', 'active' => 'bg-blue-600 text-white', 'inactive' => 'bg-white/5 text-blue-400 hover:bg-white/10 border border-white/10'],
                            'warning' => ['label' => 'Warning', 'active' => 'bg-amber-500 text-white', 'inactive' => 'bg-white/5 text-amber-400 hover:bg-white/10 border border-white/10'],
                            'error' => ['label' => 'Error', 'active' => 'bg-red-600 text-white', 'inactive' => 'bg-white/5 text-red-400 hover:bg-white/10 border border-white/10'],
                            'critical' => ['label' => 'Critical', 'active' => 'bg-rose-700 text-white', 'inactive' => 'bg-white/5 text-rose-400 hover:bg-white/10 border border-white/10'],
                        ];
                    @endphp
                ...
                <table class="w-full text-sm">
                    <thead class="sticky top-0 bg-gray-50 dark:bg-white/5 z-10">
                        <tr class="border-b border-gray-200 dark:border-white/10">
                            <th class="text-left py-2 px-3 font-medium text-white/70 w-48">Timestamp</th>
                            <th class="text-left py-2 px-3 font-medium text-white/70 w-24">Level</th>
                            <th class="text-left py-2 px-3 font-medium text-white/70">Message</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                        @forelse($logs as $entry)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                                <td class="py-2 px-3 font-mono text-xs text-white/70 whitespace-nowrap">{{ $entry['timestamp'] }}</td>
                                <td class="py-2 px-3">
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="py-8 text-center text-white/60">
